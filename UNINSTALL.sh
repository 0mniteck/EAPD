...
opkg --autoremove --force-removal-of-dependent-packages remove git git-http procps-ng-pkill mysql-server mariadb-server mariadb-client mariadb-server-plugin-auth-socket python python-mysql python-pip
